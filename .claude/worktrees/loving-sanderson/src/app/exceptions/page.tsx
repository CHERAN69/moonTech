...
export default function ExceptionQueuePage() {
  ...
  // Stats
  const byStatus = (s: MatchStatus) => DEMO_EXCEPTIONS.filter(i => i.status === s).length
      ...
      <div className="flex-1 p-6 space-y-5">
        ...
        {isDemo && (
          <div className="rounded-xl px-4 py-3 text-sm flex items-center gap-2" style={{ background: '#EFF6FF', color: '#1D4ED8' }}>
            ...
            <span><strong>Demo mode</strong> — Connect Supabase to load live exceptions from your reconciliation runs.</span>
          </div>
        )}
