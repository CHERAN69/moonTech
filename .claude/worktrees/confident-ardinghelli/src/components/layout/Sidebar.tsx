  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        {navItems.map(item => {
          ...
          return (
            ...
            >
              <span style={{ color: active ? 'white' : 'var(--text-tertiary)' }}>{item.icon}</span>
              {item.label}
            </Link>
          )
        })}
      ...
      <div className="px-3 pb-4 space-y-3">
        ...
        >
          <div className="text-xs font-semibold mb-1" style={{ color: 'var(--text-primary)' }}>Starter Plan</div>
          ...
          >
            <div
              ...
              style={{ width: '87%', background: 'var(--brand)' }}
            />
          </div>
          <Link
            href="/settings"
            className="mt-3 block text-center text-xs font-medium py-1.5 rounded-lg transition-opacity hover:opacity-90"
