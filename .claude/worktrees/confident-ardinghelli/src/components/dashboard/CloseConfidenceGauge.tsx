...
export function CloseConfidenceGauge({ score, matchedPercent = 0, openAnomalies = 0, pendingJournals = 0 }: Props) {
  ...
  return (
    ...
    >
      ...
      <p className="text-xs mb-6" style={{ color: 'var(--text-tertiary)' }}>Current period</p>
      ...
      <div className="flex flex-col items-center flex-1 justify-center">
        ...
        <div className="mt-4 w-full space-y-2">
          {[
            { label: 'Matched transactions', val: `${matchedPercent}%`, dotColor: 'var(--success)' },
            { label: 'Open anomalies', val: `${openAnomalies} flagged`, dotColor: 'var(--warning)' },
            { label: 'Journal entries pending', val: `${pendingJournals} drafts`, dotColor: 'var(--brand)' },
          ].map(item => (
