    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-5xl mx-auto px-8 pt-24 pb-20 text-center">
        ...
        <p className="text-xl text-gray-500 max-w-2xl mx-auto mb-10 leading-relaxed">
          ClosePilot automates the reconciliation work that consumes 20–50 hours per month from every finance team.
        ...
        <div className="mt-20 grid grid-cols-3 gap-8 border-t border-gray-100 pt-16">
          {[
            ...
            { stat: '1 day', label: 'average close time with ClosePilot' },
          ].map(({ stat, label }) => (
      ...
      <footer className="border-t border-gray-100 py-12">
        <div className="max-w-6xl mx-auto px-8 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm" style={{ color: '#1E3A5F' }}>ClosePilot AI</span>
          </div>
          <p className="text-sm text-gray-400">© 2026 ClosePilot AI. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
