    ...
    <aside className="w-60 flex-shrink-0 flex flex-col border-r border-gray-100 bg-white h-screen sticky top-0">
      ...
      <div className="px-3 pb-4 space-y-3">
        <div className="rounded-xl p-4" style={{ background: '#EFF6FF' }}>
          ...
          <Link href="/settings/billing" className="mt-3 block text-center text-xs font-medium py-1.5 rounded-lg text-white transition-opacity hover:opacity-90" style={{ background: '#2E75B6' }}>
            Upgrade to Growth →
          </Link>
        </div>
      </div>
